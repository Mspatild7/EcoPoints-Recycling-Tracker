            ...
            while (true) {
                ...
                switch (userChoice) {
                    ...
                    case 2:
                        ...
                        RecyclingService.logRecyclingEvent(map, bufferedWriter);
                        // System.out.println("--\n" + map + "\n--\n");
                        break;

                    case 3: // Display Reports
                        System.out.println("===================================");
                        RecyclingService.displayReports(map, bufferedWriter);
                        break;

                    case 4: // Generate Reports
                        System.out.println("===================================");
                        RecyclingService.generateReports(map, bufferedWriter);
